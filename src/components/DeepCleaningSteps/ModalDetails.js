...
const ModalDetails = ({ children, t }) => {
    ...
    // let modalmaterials = hcstate.hours * hcstate.materials * hcstate.DE.materialPrice;
    let modalmaterials = hcstate.frequency == 1 ? hcstate.hours * hcstate.materials * hcstate.DE.materialPrice :
        hcstate.frequency == 2 ? hcstate.hours * hcstate.materials * hcstate.DE.materialPrice * 2 :
            hcstate.frequency == 3 ? hcstate.hours * hcstate.materials * hcstate.DE.materialPrice * 4 : 0;
    return (
                ...
                <ScrollView showsVerticalScrollIndicator={false} style={styles.container} >
                    ...
                    <View style={{ marginHorizontal: Normalize(15), marginTop: Normalize(60) }}>
                        <View style={styles.row}>
                            ...
                            <View style={styles.item}>
                                <FontBold mystyle={{ color: '#000', fontSize: fontNormalize(18) }} value={t('deepcleaning')}></FontBold>
                            </View>
                        </View>
                        ...
                        <View style={styles.row}>
                            ...
                            <View style={styles.item}>
                                <FontBold mystyle={{ color: '#000', fontSize: fontNormalize(18) }} value={modalmaterials + ' UAH'}></FontBold>
                            </View>
                        </View>
