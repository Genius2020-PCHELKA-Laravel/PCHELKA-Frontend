...
const DeepCleaningDetails = ({ children, t }) => {
    ...
    useEffect(() => {
        ...
        subtotal = (hcstate.DE.hourPrice * hours * hcstate.cleaners) + (hcstate.materials * hcstate.hours * hcstate.DE.materialPrice);
        total = (hcstate.DE.hourPrice * hours * hcstate.cleaners) + (hcstate.materials * hcstate.hours * hcstate.DE.materialPrice);
    ...
    useEffect(() => {
        ...
        subtotal = (hcstate.DE.hourPrice * hcstate.hours * cleaners) + (hcstate.materials * hcstate.hours * hcstate.DE.materialPrice);
        total = (hcstate.DE.hourPrice * hcstate.hours * cleaners) + (hcstate.materials * hcstate.hours * hcstate.DE.materialPrice);
        if (hcstate.frequency == 2) {
            total = total * 2;
            discount = total * 0.05;
            discount = parseFloat(discount).toFixed(2);
    ...
    useEffect(() => {
        ...
        subtotal = (hcstate.DE.hourPrice * hcstate.hours * hcstate.cleaners) + (materials * hcstate.hours * hcstate.DE.materialPrice);
        total = (hcstate.DE.hourPrice * hcstate.hours * hcstate.cleaners) + (materials * hcstate.hours * hcstate.DE.materialPrice);
        if (hcstate.frequency == 2) {
            total = total * 2;
            discount = total * 0.05;
            discount = parseFloat(discount).toFixed(2);
...
export default withNamespaces()(DeepCleaningDetails);