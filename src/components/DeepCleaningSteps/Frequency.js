        ...
        <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1, backgroundColor: "#fff" }}>
            {/* <View style={styles.servicedesccontainer}>
                ...
                <View style={{ flexDirection: "row" }}>
                    ...
                    <FontLight mystyle={{ fontSize: fontNormalize(14) }} value={t('deepdesc1')} />
                </View>
                <View style={{ flexDirection: "row" }}>
                    <Octicons name="primitive-dot" size={Normalize(20)} color="#000" style={{ right: Normalize(5), top: Normalize(5) }} />
                    <FontLight mystyle={{ fontSize: fontNormalize(14) }} value={t('deepdesc2')} />
                </View>
                <View style={{ flexDirection: "row" }}>
                    <Octicons name="primitive-dot" size={Normalize(20)} color="#000" style={{ right: Normalize(5), top: Normalize(5) }} />
                    <FontLight mystyle={{ fontSize: fontNormalize(14) }} value={t('deepdesc3')} />
                </View>
                <View style={{ flexDirection: "row" }}>
                    <Octicons name="primitive-dot" size={Normalize(20)} color="#000" style={{ right: Normalize(5), top: Normalize(5) }} />
                    <FontLight mystyle={{ fontSize: fontNormalize(14) }} value={t('deepdesc4')} />
                </View>
            </View> */}
