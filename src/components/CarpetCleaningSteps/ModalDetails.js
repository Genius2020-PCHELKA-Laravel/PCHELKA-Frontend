                ...
                <ScrollView showsVerticalScrollIndicator={false} style={styles.container} >
                    ...
                    <View style={{ marginHorizontal: Normalize(15), marginTop: Normalize(60) }}>
                        ...
                        <View style={styles.row}>
                            ...
                            <View style={styles.item}>
                                <FontBold mystyle={{ color: '#000', fontSize: fontNormalize(18) }} value={hcstate.quantity + ' ' + t('carpets')}></FontBold>
                            </View>
                        </View>
                        ...
                        <View style={styles.row}>
                            ...
                            <View style={styles.item}>
                                <FontBold mystyle={{ color: '#000', fontSize: fontNormalize(18) }} value={hcstate.squaremeters + ' ' + t('meters')}></FontBold>
                            </View>
                        </View>
