...
const CarpetCleaningDetails = ({ children, t }) => {
    ...
    useEffect(() => {
        ...
        subtotal = (hcstate.CA.hourPrice * squareMeters) + (hcstate.materials * squareMeters * hcstate.CA.materialPrice);
        total = (hcstate.CA.hourPrice * squareMeters) + (hcstate.materials * squareMeters * hcstate.CA.materialPrice);
    ...
    useEffect(() => {
        ...
        subtotal = (hcstate.CA.hourPrice * hcstate.squaremeters) + (materials * hcstate.squaremeters * hcstate.CA.materialPrice);
        total = (hcstate.CA.hourPrice * hcstate.squaremeters) + (materials * hcstate.squaremeters * hcstate.CA.materialPrice);
...
export default withNamespaces()(CarpetCleaningDetails);