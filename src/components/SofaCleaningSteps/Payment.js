...
const Payment = ({ children, t }) => {
    ...
    useEffect(() => {
        ...
        var subtotal = (hcstate.SF.hourPrice * hcstate.quantity) + (hcstate.materials * hcstate.quantity * hcstate.SF.materialPrice);
        var total = (hcstate.SF.hourPrice * hcstate.quantity) + (hcstate.materials * hcstate.quantity * hcstate.SF.materialPrice);
        var discount = 0;
