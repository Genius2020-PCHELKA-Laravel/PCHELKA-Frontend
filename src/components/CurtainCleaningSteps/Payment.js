...
const Payment = ({ children, t }) => {
    ...
    useEffect(() => {
        ...
        var subtotal = (hcstate.CU.hourPrice * hcstate.squaremeters) + (hcstate.materials * hcstate.squaremeters * hcstate.CU.materialPrice);
        var total = (hcstate.CU.hourPrice * hcstate.squaremeters) + (hcstate.materials * hcstate.squaremeters * hcstate.CU.materialPrice);
        var discount = 0;
