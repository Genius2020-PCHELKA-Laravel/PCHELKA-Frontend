                ...
                <ScrollView showsVerticalScrollIndicator={false} style={styles.container} >
                    ...
                    <View style={{ marginHorizontal: Normalize(15), marginTop: Normalize(60) }}>
                        <View style={styles.row}>
                            ...
                            <View style={styles.item}>
                                <FontBold mystyle={{ color: '#000', fontSize: fontNormalize(18) }} value={t('CarpetCleaning')}></FontBold>
                            </View>
                        </View>
                        ...
                        <View style={styles.row}>
                            ...
                            <View style={styles.item}>
                                <FontBold mystyle={{ color: '#000', fontSize: fontNormalize(18) }} value={hcstate.quantity + ' ' + t('curtains')}></FontBold>
                            </View>
                        </View>
                        ...
                        <View style={styles.row}>
                            ...
                            <View style={styles.item}>
                                <FontBold mystyle={{ color: '#000', fontSize: fontNormalize(18) }} value={hcstate.squaremeters + ' ' + t('squaremeters')}></FontBold>
                            </View>
                        </View>
