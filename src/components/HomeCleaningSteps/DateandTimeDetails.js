...
const DateandTimeDetails = ({ children, t }) => {
    ...
    // let current_lang= 
    // let days_names = lang === 'en' ? en_days_names : ru_days_names;
                            ...
                            <TouchableOpacity key={u.id} style={providerid == u.id ? styles.providerThumdown : styles.providerThumup}
                                ...
                                <View style={{ flexDirection: 'row', justifyContent: "center" }}>
                                    ...
                                    }
                                    {
                                        <Badge
                                            status="success"
                                            badgeStyle={{ width: Normalize(18), height: Normalize(18), borderRadius: Normalize(10), borderColor: '#fff', borderWidth: 2 }}
