...
const Payment = ({ children, t }) => {
    ...
    useEffect(() => {
        ...
        var subtotal = (hcstate.DI.hourPrice * hcstate.hours * hcstate.cleaners) + (hcstate.hours * hcstate.materials * hcstate.DI.materialPrice);
        var total = (hcstate.DI.hourPrice * hcstate.hours * hcstate.cleaners) + (hcstate.hours * hcstate.materials * hcstate.DI.materialPrice);
