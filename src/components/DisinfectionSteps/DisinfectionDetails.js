...
const DisinfectionDetails = ({ children, t }) => {
    ...
    useEffect(() => {
        console.log("Frequency in Disinfection Details: " + hcstate.frequency);
    }, []);
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        subtotal = (hcstate.DI.hourPrice * hours * hcstate.cleaners) + (hcstate.materials * hcstate.hours * hcstate.DI.materialPrice);
        total = (hcstate.DI.hourPrice * hours * hcstate.cleaners) + (hcstate.materials * hcstate.hours * hcstate.DI.materialPrice);
    ...
    useEffect(() => {
        ...
        subtotal = (hcstate.DI.hourPrice * hcstate.hours * cleaners) + (hcstate.materials * hcstate.hours * hcstate.DI.materialPrice);
        total = (hcstate.DI.hourPrice * hcstate.hours * cleaners) + (hcstate.materials * hcstate.hours * hcstate.DI.materialPrice);
        if (hcstate.frequency == 2) {
            total = total * 2;
            discount = total * 0.05;
            discount = parseFloat(discount).toFixed(2);
    ...
    useEffect(() => {
        ...
        subtotal = (hcstate.DI.hourPrice * hcstate.hours * hcstate.cleaners) + (materials * hcstate.hours * hcstate.DI.materialPrice);
        total = (hcstate.DI.hourPrice * hcstate.hours * hcstate.cleaners) + (materials * hcstate.hours * hcstate.DI.materialPrice);
        if (hcstate.frequency == 2) {
            total = total * 2;
            discount = total * 0.05;
            discount = parseFloat(discount).toFixed(2);
...
export default withNamespaces()(DisinfectionDetails);