...
const ModalDetails = ({ children, t }) => {
    ...
    let modalmaterials = hcstate.quantity * hcstate.materials * hcstate.MA.materialPrice;
    return (
                ...
                <ScrollView showsVerticalScrollIndicator={false} style={styles.container} >
                    ...
                    <View style={{ marginHorizontal: Normalize(15), marginTop: Normalize(60) }}>
                        <View style={styles.row}>
                            ...
                            <View style={styles.item}>
                                <FontBold mystyle={{ color: '#000', fontSize: fontNormalize(18) }} value={t('mattresscleaning')}></FontBold>
                            </View>
                        </View>
                        ...
                        <View style={styles.row}>
                            ...
                            <View style={styles.item}>
                                <FontBold mystyle={{ color: '#000', fontSize: fontNormalize(18) }} value={hcstate.quantity + ' ' + t('mattresses')}></FontBold>
                            </View>
                        </View>
                        ...
                        <Spacer />
                        <FontBold mystyle={{ color: 'black', fontSize: fontNormalize(18) }} value={t('dateandtime')}></FontBold>
                        <View style={{ borderBottomColor: '#f5c500', borderBottomWidth: 1, marginTop: Normalize(5) }} />
                        <View style={styles.row}>
                            <View style={styles.item}>
