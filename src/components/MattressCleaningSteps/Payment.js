...
const Payment = ({ children, t }) => {
    ...
    useEffect(() => {
        ...
        var subtotal = (hcstate.MA.hourPrice * hcstate.quantity) + (hcstate.materials * hcstate.quantity * hcstate.MA.materialPrice);
        var total = (hcstate.MA.hourPrice * hcstate.quantity) + (hcstate.materials * hcstate.quantity * hcstate.MA.materialPrice);
        var discount = 0;
